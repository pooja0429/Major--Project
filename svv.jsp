  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="svhome.jsp">Home</a></li>
          <li><a class="nav-link scrollto active" href="svv.jsp">View Vaccine</a></li>
           <li><a class="nav-link scrollto" href="sstatus.jsp">Status</a></li>
 ...
 <%
    // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM av  where status='pending'  ");
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Link</th>
       <th scope="col">Generate Block Chain</th>
    </tr>
  </thead>
   <%
        while(rs.next()){
  ...
  <tbody>
    <tr>
        ...
        <td><a href="<%=rs.getString(11)%>"><%=rs.getString(11)%></a></td>
         <td><a href="vav1.jsp?id=<%=rs.getInt(1)%>&vname=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&image=<%=rs.getString(5)%>">Generate</a> </td>
      </tr>
  </tbody>
   <%
        }
