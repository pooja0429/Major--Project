...
//         System.out.println("ddddddddddddddddddddddddddddddddddd" + bk);
        ...
        PreparedStatement pst2=co.prepareStatement("insert into mf(username,password,email,mobile,address) values(?,?,?,?,?)");
	...
	int i= pst2.executeUpdate();
      ...
      if(i>0){
       response.sendRedirect("mf.jsp?m1=registration_success"); 
      }
      else{
          response.sendRedirect("mfreg.jsp?m2=registration_failed"); 
      }
       }
