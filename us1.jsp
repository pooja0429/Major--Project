    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="us.jsp">search</a></li>
 ...
 <%
    // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM av  where status4='pending' and  vname='"+vname+"' ");
  ...
  <tbody>
    <tr>
        ...
        <td><img src="assets/img/<%=rs.getString(5)%>" style="width:100px;height:100px;"></td>
         <td><a href="us2.jsp?id=<%=rs.getInt(1)%>&vname=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&image=<%=rs.getString(5)%>">Take</a> </td>
      </tr>
  </tbody>
   <%
        }
