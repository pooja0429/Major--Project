    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
       <ul>
          ...
          <li><a class="nav-link scrollto active" href="distb.jsp">Distributor</a></li>
...
<!--    <h1 style="color:white;margin-bottom: 50%"><b>vaccine security </b></h1><br>-->
   <center><br>
                                <h6 style="color:white">Distributor Login</h6><br>
                                
                                <form style="width: 20%;margin-bottom:  40%;" action="distbact.jsp">
