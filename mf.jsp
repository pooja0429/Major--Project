...
<!--    <h1 style="color:white;margin-bottom: 50%"><b>vaccine security </b></h1><br>-->
   <center><br>
                                <h6 style="color:white">Manufacturer Login</h6><br>
                                
                                <form style="width: 20%;margin-bottom:  40%;" action="mfact.jsp">
 ...
 <button type="submit" class="btn btn-primary">Submit</button>
  ...
  <br>                            
                                <a href="mfreg.jsp" style="color:white">If you are new  click here</a>
</form>
