    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="svv.jsp">View Vaccine</a></li>
           <li><a class="nav-link scrollto active" href="sstatus.jsp">Status</a></li>
...
<!--    <h1 style="color:white;margin-bottom: 50%"><b>vaccine security </b></h1><br>-->
     <center><br>
                               ...
                               <form style="width: 20%;margin-bottom:  30%;" action="sstatus1.jsp">
