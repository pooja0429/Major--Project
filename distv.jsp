    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="distv.jsp">View Vaccine</a></li>
           <li><a class="nav-link scrollto" href="dstatus.jsp">Status</a></li>
 ...
 <%
    // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM av  where status3='pending'  ");
  ...
  <tbody>
    <tr>
        ...
        <td><img src="assets/img/<%=rs.getString(5)%>" style="width:100px;height:100px;"></td>
         <td><a href="distv1.jsp?id=<%=rs.getInt(1)%>&vname=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&image=<%=rs.getString(5)%>">Deliver</a> </td>
      </tr>
  </tbody>
   <%
        }
