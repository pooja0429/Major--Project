  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="cdchome.jsp">Home</a></li>
          <li><a class="nav-link scrollto active" href="cdcv.jsp">View Vaccine</a></li>
          <li><a class="nav-link scrollto" href="cstatus.jsp">Status</a></li>
 ...
 <%
    // String email=session.getAttribute("email").toString();
       ...
       try{ 
        ...
        PreparedStatement pst=co.prepareStatement("SELECT *  FROM av  where status2='pending'  ");
...
<table class="table table-striped" style="width:80%;margin-bottom: 60%">
  ...
  <tbody>
    <tr>
        ...
        <td><a href="<%=rs.getString(11)%>"><%=rs.getString(11)%></a></td>
         <td><a href="cdcv1.jsp?id=<%=rs.getInt(1)%>&vname=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&image=<%=rs.getString(5)%>">Yes</a> </td>
          <td><a href="cdcvn1.jsp?id=<%=rs.getInt(1)%>&vname=<%=rs.getString(2)%>&email=<%=rs.getString(3)%>&image=<%=rs.getString(5)%>">No</a> </td>
      </tr>
  </tbody>
   <%
        }
